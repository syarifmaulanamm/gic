    ...
    <div class="row">
        ...
        <div class="col-md-3 col-xs-6">
            <div class="small-box bg-green">
                ...
                <a href="{{ url('inventory/export') }}" class="small-box-footer">
                    Export to Excel
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
    ...
    <div class='row'>
        ...
        <div class="col-md-3">
          <div class="small-box bg-aqua">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#stockIn">
                  Add Stock
                  <i class="fa fa-plus"></i>
              </a>
          </div>
          <div class="small-box bg-aqua">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#stockOut">
                  Outgoing Stock
                  <i class="fa fa-plus"></i>
              </a>
          </div>
          <div class="small-box bg-teal">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#stockReturn">
    ...
    <div class="modal fade" id="addGoods" tabindex="-1" role="dialog">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table table-bordered datatables table-responsive">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table table-bordered table-striped datatables table-responsive">
              <thead>
              <tr>
                <th>ID</th>
                <th>Name</th>
